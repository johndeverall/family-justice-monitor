# 2026 General Election — Party Questionnaire on the Family Justice System

Draft working document. Not yet sent to any party. Fill in the bracketed
placeholders (election date/month, response deadline, estimated time to
answer) before sending.

## Process notes

- Send the identical letter and question set to every party represented in
  Parliament, on the same day.
- Publish every response in full, unedited, alongside the same questions sent
  to every other party.
- If a party has not responded by the stated deadline, publish that they did
  not respond by the deadline. If a response arrives after publication, add it
  and note the date it was received.
- Same deadline for all parties — no party gets extra time relative to
  another without that also being offered (and disclosed) to the rest.

## Covering letter

**Subject: Family Justice Monitor NZ — request for your party's position on the family justice system ahead of the election**

> Dear [Party] policy/press team,
>
> My name is John Deverall, and I'm writing on behalf of Family Justice
> Monitor NZ, an independent initiative in formation to research and monitor
> New Zealand's family justice system. (We are not yet incorporated — full
> details on our governance and current status are at
> familyjusticemonitor.org.nz/about.)
>
> Every year, more than 63,000 applications are lodged in New Zealand's
> Family Court, and about a quarter of these involve custody, care, and
> access disputes affecting children. With the [Month Year] general election
> approaching, we're asking every party represented in Parliament the same
> set of questions about their position on the family justice system, so that
> voters and affected families can compare responses directly.
>
> We will publish every party's response in full on our website, unedited,
> alongside the same questions sent to every other party. If we do not
> receive a response by [date — e.g. 4 weeks from send date], we will publish
...
>
> We would appreciate a response by **[deadline date]**.
>
> Please don't hesitate to contact me directly with any questions about this
> request or about Family Justice Monitor NZ more broadly.
>
> Kind regards,
> John Deverall
> Family Justice Monitor NZ (initiative in formation)
> contact@familycourtmonitor.org.nz
> familyjusticemonitor.org.nz
...
powers into criminal trials would be "counterproductive." Does your party
support extending non-judicial decision-makers' powers within the family
justice system, and if so, in what areas?
...
on the long-term outcomes for children affected by Family Court decisions,
and would you support independent research access to this data?

**7. Oversight and accountability**
Would your party support the establishment of an independent body to monitor
and report on the performance and impacts of the family justice system?

**8. Cultural equity and Te Tiriti**
68% of children in Oranga Tamariki care and protection custody are Māori,
despite Māori being roughly 17% of New Zealand's population — a disparity
confirmed by the Independent Children's Monitor's most recent reporting. Does
your party support requiring public reporting on Family Court and Oranga
Tamariki outcomes by ethnicity, and what specific steps would your party take
to address this disparity in line with Te Tiriti o Waitangi obligations?

## Sourcing notes (for internal reference, not for publication)

- **63,114 applications, 2024/25; 81,605 guardianship cases over 5 years;
  49,195 (60%) resulted in a court order** — RNZ, "Inside the Family Court: Do
  custody rulings really put kids first?", citing Ministry of Justice data.
  https://www.rnz.co.nz/news/national/584378/inside-the-family-court-do-custody-rulings-really-put-kids-first
- **Community magistrates / Law Association submission** — lawnews.nz,
  "The Law Association tells Parliament expanding community magistrates'
  criminal trial powers will be counterproductive."
- **68% Māori in Oranga Tamariki care and protection custody, 2024/25** —
  Independent Children's Monitor (Aroturuki Tamariki),
  "Over-representation of Māori in the oranga tamariki system."
  Scope note: this figure is specifically about Oranga Tamariki care and
